					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">District</h2>
							<?php
                                ...
                                $sqlquery = "SELECT * FROM advertisement WHERE vehicle_condition='Used' AND catagory='Cars' ORDER BY date DESC";
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                    {
                                        $data[] = $row;
                                          ...
                                          $_SESSION['addusedcars1']= $data[0]['aid'];
                                          $_SESSION['addusedcars2']= $data[1]['aid'];
                                          $_SESSION['addusedcars3']= $data[2]['aid'];
                                          $_SESSION['addusedcars4']= $data[3]['aid'];                          
                                          $_SESSION['addusedcars5']= $data[4]['aid'];
                                          $_SESSION['addusedcars6']= $data[5]['aid'];
                                          $_SESSION['addusedcars7']= $data[6]['aid'];
...
$sql7 = "SELECT * FROM img WHERE aid=$g";
  ...
  $row7 = mysqli_fetch_assoc($result7);
						    ...
						    <tr>
						         <td>
						             <a href="addusedcars.php"> <table width="100%">
						                <tr>
