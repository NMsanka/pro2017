				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <button class="btn btn-primary btn-block" onclick="location.href='viewused.php';">Back</button><br>
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">District</h2>
							<?php
                                ...
                                $sqlquery = "SELECT * FROM advertisement WHERE vehicle_condition='Used' AND catagory='Motor Bikes' ORDER BY date DESC";
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                    {
                                        $data[] = $row;
                                          ...
                                          $_SESSION['addusedbike1']= $data[0]['aid'];
                                          $_SESSION['addusedbike2']= $data[1]['aid'];
                                          $_SESSION['addusedbike3']= $data[2]['aid'];
                                          $_SESSION['addusedbike4']= $data[3]['aid'];                          
                                          $_SESSION['addusedbike5']= $data[4]['aid'];
                                          $_SESSION['addusedbike6']= $data[5]['aid'];
                                          $_SESSION['addusedbike7']= $data[6]['aid'];
...
$sql7 = "SELECT * FROM img WHERE aid=$g";
  ...
  $row7 = mysqli_fetch_assoc($result7);
						    ...
						    <tr>
						         <td>
						             <a href="addusedbike.php"> <table width="100%">
						                <tr>
