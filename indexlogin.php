						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<button type="button" class="btn btn-default get" onclick="location.href='postadd.php';">Post Your Add</button>
								</div>
								<div class="col-sm-6">
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            <button class="btn btn-primary btn-block" onclick="location.href='viewadd.php';">View Adds</button><br>
						...
						<h2 class="title text-center">District</h2>
						    ...
						    <tr>
								...
								<ul class="nav nav-pills nav-stacked">
						            ...
						            <td><div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="viewadddistrict.php">Colombo</a></li>
